...
> **Note:** Phase 2 planning exists only in roadmap tables right now; create the directory once concrete docs are authored.
...
| Phase 2 | Enhance semantic search and ranking (planned). | _(Docs pending — no directory yet)_ |
| Phase Final | Production blueprint with PostgreSQL, Celery, monitoring, Streamlit UI. | `phase_final/README.md`, `phase_final/docs/*.md`, `phase_final/architecture/*.md` |
