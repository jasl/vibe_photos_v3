...
class RTMDetDetector:
    ...
    def _init_model(self):
        ...
        if not Path(checkpoint_file).exists():
            ...
            print("wget https://download.openmmlab.com/mmdetection/phase_final.0/rtmdet/rtmdet_l_8xb32-300e_coco/rtmdet_l_8xb32-300e_coco_20220719_112030-5a0be7c4.pth")
            self.model = None
            return
