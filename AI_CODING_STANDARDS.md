...
- Configuration values go through `pydantic-settings`; no hard-coded paths except constants defined in `DIRECTORY_STRUCTURE.md`.
...
- When module behavior changes, update `AI_IMPLEMENTATION_DETAILS.md` and relevant blueprint docs.
- Keep example code runnable; prefer doctest-style snippets when feasible.
- Append rationale for deviations to `decisions/AI_DECISION_RECORD.md`.
