...
BLUEPRINT_ROOT = REPO_ROOT / "blueprints" / "phase1"
...
def print_next_steps() -> bool:
    ...
    print("   • Download perception models: `uv run python download_models.py`.")
    print("   • Process the sample dataset: `uv run python process_dataset.py`.")
